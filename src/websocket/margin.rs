use crate::{
    error::BinanceError, models::Product, parser::string_or_decimal, parser::string_or_decimal_opt,
...
pub struct OrderTradeUpdate {
    ...
    #[serde(rename = "n", default, with = "string_or_decimal_opt")]
